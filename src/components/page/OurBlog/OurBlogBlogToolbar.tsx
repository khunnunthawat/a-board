...
import { useAuth, useDebounce, usePost } from '@/hooks';
import { communityOptions } from '@/helper/option';

const OurBlogBlogToolbar = () => {
  ...
  }, [userId, router, debouncedSearchQuery, selectedCommunity]);
      ...
      >
        <Listbox value={selectedCommunity} onChange={setSelectedCommunity}>
          <div className='relative'>
            <ListboxButton className='relative flex justify-between w-full cursor-pointer min-w-[140px] bg-transparent border-none py-2 px-3.5 text-base font-medium text-text outline-none'>
...
export default OurBlogBlogToolbar;
